...
@UsingDataSet({"datasets/bookWords.yml", "datasets/userWords.yml", "datasets/words.yml", "datasets/users.yml"})
public class UserWordDaoBeanTest {
    @Inject
    private UserWordDaoBean userWordDao;
    ...
    @Test
    public void getAllWordsForUserTest() {
        List<UserWord> allWordsForUser = userWordDao.getAllWordForUser(1L);
